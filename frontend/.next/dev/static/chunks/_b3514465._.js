...
function TemplatesPage() {
    ...
    const loadTemplates = async ()=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].listTemplates();
        ...
        try {
            ...
            const response = await fetch(`${baseURL}/templates/add`, {
                ...
                body: JSON.stringify({
                    ...
                    layers_count: parseInt(formData.layers_count)
                })
            });
            if (!response.ok) {
...
_s(TemplatesPage, "i6XxHRyXlpdEhtXRYsGDfLOsyXY=", false, function() {
    return [
...
//# sourceMappingURL=_b3514465._.js.map