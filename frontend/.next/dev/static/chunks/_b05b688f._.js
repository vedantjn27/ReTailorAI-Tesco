...
function AssetsPage() {
                ...
                "AssetsPage.useCallback[handleUpload].uploadPromises": async (file)=>{
                    try {
                        ...
                        const newAsset = {
                            ...
                            uploadedAt: new Date(),
                            thumbnail: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getAssetUrl(result.file_id),
                            type: "image"
                        };
                        toast({
    ...
    const handleRemoveBackground = async (fileId)=>{
        ...
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].removeBackground(fileId);
            console.log("[v0] Remove BG result:", result);
            const newAsset = {
                fileId: result.new_file_id,
                filename: "Background Removed",
                uploadedAt: new Date(),
                thumbnail: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getAssetUrl(result.new_file_id),
                type: "enhanced"
            };
            setAssets((prev)=>[
                    newAsset,
    ...
    const handleSmartEnhance = async (fileId)=>{
        setProcessing(true);
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].smartEnhance(fileId, false);
            const newAsset = {
                fileId: result.new_file_id,
    ...
    const handleDelete = async (fileId)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].deleteAsset(fileId);
...
_s(AssetsPage, "d3/476FvbhY4Ym4SdNY2Fk9TxYk=", false, function() {
    return [
...
//# sourceMappingURL=_b05b688f._.js.map