...
function EditorPage() {
    ...
    const [showNameDialog, setShowNameDialog] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [zoom, setZoom] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0.5);
    ...
    const [productNameAI, setProductNameAI] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditorPage.useEffect": ()=>{
            if (selectedLayer?.type === "text") setEditingText(selectedLayer.text || "");
        }
    }["EditorPage.useEffect"], [
        selectedLayer
    ]);
    ...
    const initProject = async (name)=>{
        ...
        try {
            ...
            const result = await api(`/editor/create-project?${params}`, {
                method: "POST"
            });
            const projectData = await api(`/editor/${result.project_id}`);
            setProject(projectData);
            setProjectName(name);
            // persist to localStorage
            const saved = JSON.parse(localStorage.getItem("retailor_projects") || "[]");
            saved.push({
            ...
            localStorage.setItem("retailor_projects", JSON.stringify(saved));
            toast({
    ...
    const refreshProject = async ()=>{
        ...
        setProject(updated);
        if (selectedLayer) {
            const refreshed = updated.layers.find((l)=>l.layer_id === selectedLayer.layer_id);
            setSelectedLayer(refreshed || null);
        }
    };
    ...
    const handleUpdateLayer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EditorPage.useCallback[handleUpdateLayer]": async (layerId, updates)=>{
            if (!project) return;
            try {
    ...
    }["EditorPage.useCallback[handleUpdateLayer]"], [
        project
    ]);
    ...
    const handleExport = async (format = "png")=>{
        ...
        setLoading(true);
        try {
            const result = await api(`/editor/${project._id}/render`);
            const downloadUrl = `${API_BASE}/editor/rendered/${result.rendered_file_id}/download`;
            const link = document.createElement("a");
            link.href = downloadUrl;
            link.download = `${projectName || "creative"}.${format}`;
    ...
    const onCanvasMouseMove = (e)=>{
        ...
        setProject((prev)=>{
            ...
            return {
                ...prev,
                layers: prev.layers.map((l)=>l.layer_id === dragging.layerId ? {
                        ...l,
                        x: newX,
                        y: newY
                    } : l)
        ...
        if (selectedLayer?.layer_id === dragging.layerId) {
            setSelectedLayer((prev)=>prev ? {
                    ...prev,
                    x: newX,
                    y: newY
                } : prev);
    ...
    const onCanvasMouseUp = async ()=>{
        ...
        const layer = project.layers.find((l)=>l.layer_id === dragging.layerId);
        if (layer) {
            await handleUpdateLayer(dragging.layerId, {
                x: layer.x,
                y: layer.y
            });
        }
    ...
    const fetchAISuggestions = async ()=>{
        ...
        try {
            const res = await api("/ai/copy-suggestions", {
                ...
                body: JSON.stringify({
                    product_name: productNameAI,
                    platform: "instagram",
                    tone: "professional",
                    num_variants: 3
                })
            });
            setAiSuggestions(res.variants || []);
        } catch (e) {
            toast({
                title: "AI Error",
                description: e.message,
    ...
    const applyAISuggestion = async (variant)=>{
        if (!project) return;
        const params = new URLSearchParams({
        ...
        await api(`/editor/${project._id}/add-text-layer?${params2}`, {
            method: "POST"
        });
        await refreshProject();
        toast({
            title: "AI Copy Applied",
            description: `Headline and CTA added`
        });
    };
    // ── Render ─────────────────────────────────────────────────────────────────
    const renderLayerPreview = (layer)=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                isSelected && !layer.locked && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    style: {
                        position: "absolute",
                        inset: 0,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                    children: "Set up your canvas to start designing"
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/editor/page.tsx",
                                    lineNumber: 355,
                                    columnNumber: 13
                        ...
                        children: [
                            ...
                            showAiPanel && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                        ...
                                        value: productNameAI,
                                        onChange: (e)=>setProductNameAI(e.target.value),
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        disabled: aiLoading || !productNameAI.trim(),
                                        children: [
                                    ...
                                    aiSuggestions.map((s, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: selectedLayer ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$textarea$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Textarea"], {
                                                                ...
                                                                onBlur: ()=>{
                                                                    if (editingText !== selectedLayer.text) handleUpdateLayer(selectedLayer.layer_id, {
                                                                        text: editingText
                                                                    });
                                                                }
                                                            }, void 0, false, {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                                ...
                                                                onValueChange: (v)=>handleUpdateLayer(selectedLayer.layer_id, {
                                                                        font_family: v
                                                                    }),
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectTrigger"], {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            "right"
                                                                ...
                                                                size: "sm",
                                                                variant: selectedLayer.text_align === a ? "secondary" : "ghost",
                                                                className: "h-7 flex-1 p-0",
                                                                onClick: ()=>handleUpdateLayer(selectedLayer.layer_id, {
                                                                        text_align: a
                                                                    }),
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                children: "Click a layer to select it"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/editor/page.tsx",
                                                lineNumber: 505,
                                                columnNumber: 19
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        className: "w-full h-8 bg-transparent gap-2 text-xs",
                                        variant: "outline",
                                        onClick: ()=>handleExport("jpeg"),
                                        disabled: !project || loading,
                                        children: "Export JPEG"
                                    }, void 0, false, {
                                        fileName: "[project]/app/(dashboard)/editor/page.tsx",
                                        lineNumber: 520,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: !project ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    children: "Enter a project name above to start"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/(dashboard)/editor/page.tsx",
                                                    lineNumber: 556,
                                                    columnNumber: 19
                                            ...
                                            style: {
                                                ...
                                                backgroundImage: showGrid ? `repeating-linear-gradient(0deg,#e5e7eb 0px,#e5e7eb 1px,transparent 1px,transparent ${20 * zoom}px),repeating-linear-gradient(90deg,#e5e7eb 0px,#e5e7eb 1px,transparent 1px,transparent ${20 * zoom}px)` : undefined,
                                                flexShrink: 0
                                            },
                                            onClick: ()=>setSelectedLayer(null),
                                            children: project.layers.map(renderLayerPreview)
                                        }, void 0, false, {
                                            fileName: "[project]/app/(dashboard)/editor/page.tsx",
                                            lineNumber: 559,
                                            columnNumber: 17
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$scroll$2d$area$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollArea"], {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...project.layers
                                                    ].reverse().map((layer, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: `flex items-center gap-1.5 rounded px-2 py-1.5 cursor-pointer text-xs transition-colors ${selectedLayer?.layer_id === layer.layer_id ? "bg-primary/10 text-primary" : "hover:bg-muted/50"}`,
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    children: layer.type === "text" ? layer.text?.substring(0, 12) || "Text" : "Image"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/(dashboard)/editor/page.tsx",
                                                                    lineNumber: 595,
                                                                    columnNumber: 25
...
_s(EditorPage, "pIN2ruquZX13xjO7kZo6dctMGYg=", false, function() {
    return [
...
//# sourceMappingURL=_ad0850a9._.js.map