...
function EnhancePage() {
    ...
    const handleSmartEnhance = async (upscale = false)=>{
        ...
        setProcessing(true);
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].smartEnhance(fileId, upscale);
            setResultImage({
                fileId: result.new_file_id,
                url: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].getAssetUrl(result.new_file_id)
            });
            toast({
    ...
    const handleAutoResize = async ()=>{
        ...
        setProcessing(true);
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].autoResize(fileId, false);
            const resultsWithUrls = result.files.map((file)=>({
                    ...file,
                    url: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].getAssetUrl(file.file_id)
                }));
...
//# sourceMappingURL=_24b439a6._.js.map